...
const NomineeInfo = () => {
  ...
  console.log(remainingShare);

  // console.log(clientImage, clientNidFontImg, clientNidBackImg);
useEffect(()=>{
  fetch(
  ...
  const onSubmit = (data) => {
    ...
    const inputShared = data?.percentage;
    // console.log(inputShared);
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="grid grid-cols-2 gap-5">
          ...
          <div className="form-control">
            ...
            {errors.membership_number && (
              <p className="py-1 text-red-900">Membership Number is required.</p>
            )}
          </div>
          <div className="form-control">
            <label className="label">
            ...
            />
            {errors.fullname && <p className="py-1 text-red-900">Name is required.</p>}
          </div>
          <div className="form-control">
            <label className="label">
          ...
          <div className="form-control">
            ...
            />
            {errors.nid_number && (
              <p className="py-1 text-red-900">National id number is required.</p>
            )}
          </div>
          <div className="form-control">
            <label className="label">
        ...
        <div className="flex my-2">
          <div className="form-control">
            ...
            />
            {errors.picture && (
              <p className="py-1 text-red-900">Nominee Profile Picture is required.</p>
            )}
          </div>
          <div className="m-3">
            {clientImage && (
          ...
          <div className="form-control">
            ...
            {errors.nid_picture_front && (
              <p className="py-1 text-red-900">Nominee NID Front Picture is required.</p>
            )}
          </div>
          <div className="m-3">
            {clientNidFontImg && (
          ...
          <div className="form-control">
            ...
            {errors.nid_picture_back && (
              <p className="py-1 text-red-900">Nominee NID Back Picture is required.</p>
            )}
          </div>
          <div className="m-3">
            {clientNidBackImg && (
